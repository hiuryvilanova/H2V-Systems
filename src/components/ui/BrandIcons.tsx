...
export function WhatsAppIcon({ size = 20, color = 'currentColor', ...rest }: IconProps) {
  return (
    <svg
...
export function LinkedInIcon({ size = 20, color = 'currentColor', ...rest }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function GitHubIcon({ size = 20, color = 'currentColor', ...rest }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
